        ...
        <div className="w-[1219px] mb-8 ">
          ...
          <div className="h-[907px] bg-[#181818] flex flex-col justify-center items-center ">
            <div className="w-[800px] relative">
              <label className=" inline-block w-[100px] text-[15px] font-[400] text-gray-400 ">
                Active (Typing)
              </label>
              <input
                className=" text-gray-400 w-[335px] h-[38px] border-2  rounded-md p-1.5 ml-20 mb-8 hover:text-white focus:outline-none focus:border-sky-500 transition-colors "
              ...
              <span className="absolute text-gray-500 text-[12px] bg-[#181818] top-[-8px] left-[198px]">
                Password
              </span>

              {isFocused && (
                <div className="absolute top-full left-[178px] w-[335px] bg-[#242424] rounded-[8px] p-4 text-sm mt-2 z-10">
